...
) ENGINE=InnoDB AUTO_INCREMENT=61441 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=504611 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary view structure for view `games_live`
--

DROP TABLE IF EXISTS `games_live`;
/*!50001 DROP VIEW IF EXISTS `games_live`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `games_live` AS SELECT 
 1 AS `game_id`,
 1 AS `name`,
 1 AS `art_url`*/;
...
--
-- Temporary view structure for view `live_stream_user_vote_view`
--

DROP TABLE IF EXISTS `live_stream_user_vote_view`;
/*!50001 DROP VIEW IF EXISTS `live_stream_user_vote_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `live_stream_user_vote_view` AS SELECT 
 1 AS `stream_id`,
 1 AS `user_id`,
 1 AS `title`,
 1 AS `started`,
...
CREATE TABLE `user` (
  ...
  FULLTEXT KEY `index5` (`name`),
  FULLTEXT KEY `description_text_index` (`description`),
...
--
-- Temporary view structure for view `user_vote_ratio_view`
--

DROP TABLE IF EXISTS `user_vote_ratio_view`;
/*!50001 DROP VIEW IF EXISTS `user_vote_ratio_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
--
-- Dumping events for database 'twitch'
--
...
--
-- Final view structure for view `games_live`
--
...
/*!50001 VIEW `games_live` AS select `game`.`game_id` AS `game_id`,`game`.`name` AS `name`,`game`.`art_url` AS `art_url` from `game` where `game`.`game_id` in (select `live_streams_view`.`game_id` from `live_streams_view`) */;
...
--
-- Final view structure for view `live_stream_user_vote_view`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `live_stream_user_vote_view` AS select `live_streams_view`.`stream_id` AS `stream_id`,`live_streams_view`.`user_id` AS `user_id`,`live_streams_view`.`title` AS `title`,`live_streams_view`.`started` AS `started`,`live_streams_view`.`thumbnail` AS `thumbnail`,`live_streams_view`.`view_count` AS `view_count`,`live_streams_view`.`game_id` AS `game_id`,`live_streams_view`.`stream_type_id` AS `stream_type_id`,`live_streams_view`.`language_id` AS `language_id`,`user`.`login` AS `login`,`user`.`name` AS `name`,`user`.`description` AS `description`,`user`.`user_type_id` AS `user_type_id`,`user`.`broadcaster_type_id` AS `broadcaster_type_id`,`user`.`offline_image` AS `offline_image`,`user`.`profile_image` AS `profile_image`,`user`.`total_views` AS `total_views`,`user_vote_ratio_view`.`ratio` AS `ratio`,`latest_followers_update_view`.`followers` AS `followers` from (((`live_streams_view` left join `user` on((`live_streams_view`.`user_id` = `user`.`user_id`))) left join `user_vote_ratio_view` on((`user_vote_ratio_view`.`user_id` = `live_streams_view`.`user_id`))) left join `latest_followers_update_view` on((`latest_followers_update_view`.`user_id` = `live_streams_view`.`user_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-03-12 20:38:04
